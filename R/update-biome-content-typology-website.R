...
qry <- sprintf("SELECT b.biome_code,b.name,d.description,d.version,d.update FROM biomes as b LEFT JOIN biome_descriptions as d
ON b.biome_code=d.biome_code WHERE d.version='v2.0'")
